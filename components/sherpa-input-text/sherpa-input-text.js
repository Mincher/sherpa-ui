 ...
 * Basic text input extending AuxInputBase.
 *
 * @example
 ...
 *
 * Attributes (inherited from AuxInputBase):
...
export class AuxInputText extends AuxInputBase {
...
customElements.define('sherpa-input-text', AuxInputText);
