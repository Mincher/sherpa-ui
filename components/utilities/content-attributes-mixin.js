...
export function ContentAttributesMixin(Base) {
  return class extends Base {
    ...
    get querySrc() { return this.getAttribute('data-query-src') || ''; }
    get queryKey() { return this.getAttribute('data-query-key') || ''; }
    get name() { return this.getAttribute('data-label') || ''; }
    // Avoid clobbering HTMLElement.dataset (DOMStringMap)
    get datasetName() { return this.getAttribute('data-dataset') || ''; }
    get category() { return this.getAttribute('data-category') || null; }
    get series() { return this.getAttribute('data-series') || null; }
    get valueField() { return this.getAttribute('data-value-field') || ''; }
    get agg() { return this.getAttribute('data-agg') || 'sum'; }
    get measures() { return this.#parseJsonAttr('data-measures', []); }
    get orderBy() { return this.#parseJsonAttr('data-order-by', []); }
    get segmentField() { return this.getAttribute('data-segment-field') || null; }
    get showStatus() { return this.getAttribute('data-show-status') !== 'false'; }
    get unit() { return this.getAttribute('data-unit') || ''; }
    get sortField() { return this.getAttribute('data-sort-field') || null; }
    get sortDirection() { return this.getAttribute('data-sort-direction') || 'asc'; }
    get limit() { 
      const v = this.getAttribute('data-limit');
      return v ? parseInt(v, 10) : null;
    }
    get filters() { return this.#parseJsonAttr('data-filters', []); }
    get visible() { return this.getAttribute('data-visible') !== 'false'; }
    get showHeader() { return this.getAttribute('data-show-header') !== 'false'; }
    get showHeaderControls() { return this.getAttribute('data-show-header-controls') !== 'false'; }
    get showViewMenu() { return this.getAttribute('data-show-view-menu') !== 'false'; }
    get presentationType() { return this.getAttribute('data-presentation-type') || null; }
    get fields() { return this.#parseJsonAttr('data-fields', null); }

    // Legacy getters (map to new format)
    get factTable() { return null; }
    get dimensions() {
    ...
    setName(name) { this.setAttribute('data-label', name); return this; }
    setDataset(dataset) { this.setAttribute('data-dataset', dataset); return this; }
    setCategory(category) {
      category ? this.setAttribute('data-category', category) : this.removeAttribute('data-category');
      return this;
    }
    setSeries(series) {
      series ? this.setAttribute('data-series', series) : this.removeAttribute('data-series');
      return this;
    }
    setValueField(field) { this.setAttribute('data-value-field', field); return this; }
    setAgg(agg) { this.setAttribute('data-agg', agg); return this; }
    ...
    getDataset() { return this.datasetName; }
    setSegmentField(field) { 
      field ? this.setAttribute('data-segment-field', field) : this.removeAttribute('data-segment-field');
      return this;
    }
    setShowStatus(show) { this.setAttribute('data-show-status', String(show)); return this; }
    setUnit(unit) { unit ? this.setAttribute('data-unit', unit) : this.removeAttribute('data-unit'); return this; }
    setSortField(field) { 
      field ? this.setAttribute('data-sort-field', field) : this.removeAttribute('data-sort-field');
      return this;
    }
    setSortDirection(dir) { this.setAttribute('data-sort-direction', dir); return this; }
    setLimit(limit) { 
      limit !== null ? this.setAttribute('data-limit', String(limit)) : this.removeAttribute('data-limit');
      return this;
    }
    setFilters(filters) { this.setAttribute('data-filters', JSON.stringify(filters || [])); return this; }
    setVisible(visible) {
    ...
    setPresentationType(type) {
      type ? this.setAttribute('data-presentation-type', type) : this.removeAttribute('data-presentation-type');
      return this;
    }
    setFields(fields) {
      Array.isArray(fields) ? this.setAttribute('data-fields', JSON.stringify(fields)) : this.removeAttribute('data-fields');
      return this;
    }

    // Legacy setters (no-ops or mapped)
    setFactTable() { return this; }
    setDimensions(dims) {
    ...
    setConfig(config) {
      ...
      if (config.queryKey !== undefined) this.setAttribute('data-query-key', config.queryKey);
      if (config.querySrc !== undefined) this.setAttribute('data-query-src', config.querySrc);
      ...
      if (config.valueField !== undefined) this.setValueField(config.valueField);
      ...
      if (config.timerange !== undefined) this.setAttribute('data-timerange', config.timerange);
      if (config.segmentField !== undefined) this.setSegmentField(config.segmentField);
      if (config.showStatus !== undefined) this.setShowStatus(config.showStatus);
      if (config.unit !== undefined) this.setUnit(config.unit);
      if (config.sortField !== undefined) this.setSortField(config.sortField);
      if (config.sortDirection !== undefined) this.setSortDirection(config.sortDirection);
      if (config.limit !== undefined) this.setLimit(config.limit);
      if (config.visible !== undefined) this.setVisible(config.visible);
      if (config.showHeader !== undefined) this.setShowHeader(config.showHeader);
      if (config.showHeaderControls !== undefined) this.setShowHeaderControls(config.showHeaderControls);
      if (config.showViewMenu !== undefined) this.setShowViewMenu(config.showViewMenu);
      if (config.presentationType !== undefined) this.setPresentationType(config.presentationType);
    ...
    async load(initialFilters = []) {
      ...
      try {
        ...
        config.queryKey = key;
        if (this.hasAttribute('data-show-status')) config.showStatus = this.showStatus;
        ...
        if (this.hasAttribute('data-dataset')) config.dataset = this.datasetName;
        ...
        if (this.hasAttribute('data-value-field')) config.value = this.valueField;
        ...
        if (Array.isArray(config.values) && config.values.length && !config.measures?.length) {
