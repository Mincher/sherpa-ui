...
export const CURATION = {
  "sherpa-button": {
    ...
    presets: [
      { id: "primary",   label: "Primary",            attrs: { "data-variant": "primary",            "data-size": "base",  "data-label": "Save changes" } },
      { id: "secondary", label: "Secondary",          attrs: { "data-variant": "secondary",          "data-size": "base",  "data-label": "Cancel" } },
      { id: "tertiary",  label: "Tertiary",           attrs: { "data-variant": "tertiary",           "data-size": "base",  "data-label": "Edit" } },
      { id: "tertiary-oc", label: "Tertiary on color", attrs: { "data-variant": "tertiary-on-color", "data-size": "base",  "data-label": "Sign in" } },
      { id: "icon-end",  label: "With trailing icon", attrs: { "data-variant": "primary",            "data-size": "base",  "data-label": "Continue", "data-icon-end": "\uf054" } },
      { id: "small",     label: "Small",              attrs: { "data-variant": "primary",            "data-size": "small", "data-label": "Save" } },
      { id: "large",     label: "Large",              attrs: { "data-variant": "primary",            "data-size": "large", "data-label": "Continue" } },
      { id: "disabled",  label: "Disabled",           attrs: { "data-variant": "primary",            "data-size": "base",  "data-label": "Submit", "disabled": "" } },
    ],
  },
  ...
  "sherpa-callout": {
    attrs: {
      ...
      "data-dismissible": { group: "behavior" },
      "data-expanded":    { group: "behavior" },
      "data-icon":        { group: "data" },
    },
    presets: [
      { id: "info",     label: "Info",     attrs: { "data-status": "info",     "data-heading": "Heads up" },        html: "This action will be logged for audit." },
      { id: "warning",  label: "Warning",  attrs: { "data-status": "warning",  "data-heading": "Review needed" },   html: "Some fields require your attention." },
      { id: "critical", label: "Critical", attrs: { "data-status": "critical", "data-heading": "Cannot continue" }, html: "Resolve the errors below to proceed." },
      { id: "success",  label: "Success",  attrs: { "data-status": "success",  "data-heading": "All set" },         html: "Your changes have been saved." },
      { id: "tip",      label: "Tip",      attrs: { "data-status": "tip",      "data-heading": "Pro tip" },         html: "Use ⌘K to quickly jump between views." },
      { id: "no-heading", label: "Body only", attrs: { "data-status": "info" }, html: "Inline guidance without a heading." },
    ],
    nested: { expose: false },
  },
  ...
  "sherpa-card": {
    attrs: {
      ...
      "data-selectable":  { group: "state",   featured: true },
      "data-selected":    { group: "state",   featured: true },
      "data-interactive": { group: "state" },
      "disabled":         { group: "state" },
      "data-pad":         { group: "layout" },
    },
    presets: [
      { id: "default",    label: "Default",    attrs: { "data-elevation": "none" } },
      { id: "raised",     label: "Raised",     attrs: { "data-elevation": "sm" } },
      { id: "elevated",   label: "Elevated",   attrs: { "data-elevation": "lg" } },
      { id: "selectable", label: "Selectable", attrs: { "data-selectable": "true" } },
      { id: "selected",   label: "Selected",   attrs: { "data-selectable": "true", "data-selected": "true" } },
      { id: "disabled",   label: "Disabled",   attrs: { "data-interactive": "true", "disabled": "" } },
    ],
    nested: { expose: true },
  },
